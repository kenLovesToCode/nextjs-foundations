...
import CustomizedComponents from "@/components/react-customized-components";
    ...
    <main className="container mx-auto p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm mb-4">
              shadcn/ui provides a complete design system with consistent tokens
              and patterns.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm mb-4">
              Since you own the component code, you can modify anything to match
              your requirements.
            </p>
